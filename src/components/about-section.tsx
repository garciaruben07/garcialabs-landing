...
export function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="py-24 bg-gradient-to-br from-white via-garciablue-50/20 to-white relative overflow-hidden"
    >
      {/* Background Effects */}
      <div className="absolute inset-0">
        <div className="absolute top-20 right-1/4 w-48 h-48 bg-garciablue-500/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-1/4 w-64 h-64 bg-garciablue-400/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            className="bg-white backdrop-blur-sm rounded-2xl p-8 sm:p-10 border border-gray-200 shadow-xl mb-12"
          >
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-garciablue-50 rounded-xl p-6 border border-garciablue-200">
          ...
          >
            {trustPillars.map((pillar, index) => (
              <motion.div key={index} variants={itemVariants}>
                <Card className="h-full bg-white border-gray-200 hover:shadow-xl transition-all duration-300 group">
          ...
          >
            {credentials.map((credential, index) => (
              <motion.div key={index} variants={itemVariants}>
                <div className="text-center p-6 bg-garciablue-50/50 rounded-xl border border-garciablue-200/50">
